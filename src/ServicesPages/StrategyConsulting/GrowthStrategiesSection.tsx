...
const GrowthStrategiesSection = () => {
  ...
  const deliverables = [
    "Commercial Objective Setting",
    "Channel Mix Recommendations",
    "Budget Allocation Strategy",
    "Messaging & Positioning Direction",
    ...
    >
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
            ...
            <div className="growth-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                ...
                <img
                  ...
                  className="growth-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-40 pointer-events-none"
                  style={{ filter: 'brightness(0)' }}
                  alt="Growth Strategy Background Grid"
                />
        ...
        <div className="w-full mt-8">
          <h3 className="growth-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
