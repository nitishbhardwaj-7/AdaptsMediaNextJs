        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start">
            ...
            <div className="market-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-blue-50/90">
              <p>
                Assumptions about your market are expensive. Real research gives you data on customer behaviour, category trends and competitive gaps that makes every marketing decision sharper. We conduct primary and secondary market research tailored to your specific business questions, not generic category reports.
              </p>
              <p>
