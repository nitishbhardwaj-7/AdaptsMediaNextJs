...
const DigitalAuditSection = () => {
  ...
  const deliverables = [
    ...
    "Paid Media Account Review",
    "Analytics & Tracking Audit",
    "Social & Content Performance Review",
    "Prioritised Fix List & Recommendations",
  ];
    ...
    >
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start">
            ...
            <div className="audit-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-gray-300">
              <p>
                Most brands do not have a clear picture of how their digital presence is actually performing. Tracking gaps, inconsistent attribution, underperforming pages and wasted ad spend are common. A full digital audit finds every problem before it keeps costing you money.
              </p>
              <p>
                We audit your website, SEO health, paid media accounts, analytics setup, social channels and email performance in a single integrated review. Every finding comes with a priority rating and a recommended fix, so you know what to address first and the commercial case for addressing it.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="audit-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img
                  src="/images/BrandingCreative/WhiteLogoBg.png"
                  className="audit-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-40 pointer-events-none"
                  style={{ filter: 'brightness(0)' }}
                  alt="Audit Background Grid"
                />

                {/* Main Illustration */}
                <img
                  src="/images/BrandingCreative/WhiteLogo.png"
                  className="audit-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.75]"
        ...
        <div className="w-full mt-8">
          <h3 className="audit-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div key={idx} className="audit-deliverable-item service-deliverable-item flex items-start gap-2.5">
