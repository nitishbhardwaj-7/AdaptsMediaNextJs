...
const ContentStrategySection = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full py-24 md:py-32 flex justify-center overflow-hidden bg-[#4a154b] text-white">
      {/* Background Image */}
      <Image
        ...
        priority={true}
        quality={90}
        className="absolute inset-0 z-0 pointer-events-none object-cover opacity-60 mix-blend-multiply"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center order-2 lg:order-1">
            ...
            <div className="mt-8">
              <a
                href="#"
                className="service-cta inline-flex items-center justify-center px-10 py-3.5 rounded-full border border-white/60 bg-transparent text-white font-semibold text-[15px] md:text-base tracking-wide transition-all duration-300 hover:bg-white hover:text-[#4a154b] hover:border-white shadow-md cursor-pointer"
              >
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start order-1 lg:order-2">
            ...
            <div className="contentstrategy-desc service-desc space-y-6 max-w-xl text-[17px] md:text-[19px] font-light leading-relaxed text-purple-100/90">
              <p>
                Great content starts with understanding people. We develop content strategies that align your messaging with audience behavior, platform trends, and business goals.
              </p>
              <p>
                From storytelling to social content planning, we create frameworks that help brands stay relevant, consistent, and engaging over time.
              </p>
            </div>
          </div>
        </div>
