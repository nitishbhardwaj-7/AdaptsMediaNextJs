...
const ContentCreationSection = () => {
  ...
  const deliverables = [
    ...
    "Scalable Asset Engine",
    "Campaign Creative Hooks",
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start">
            ...
            <div className="creation-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-gray-300">
              ...
              <p>
                From vertical video scripts engineered for retention to long-form editorial pieces that build authority, we deliver assets that look premium & perform under pressure.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="creation-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img
                  src="/images/BrandingCreative/WhiteLogoBg.png"
                  className="creation-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-40 pointer-events-none"
                  style={{ filter: 'brightness(0)' }}
                  alt="Content Creation Background Grid"
                />
