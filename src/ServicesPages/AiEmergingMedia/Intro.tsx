      ...
      >
        <div className="w-full max-w-[1050px] mx-auto">
          <p className="intro-paragraph reveal-text text-[clamp(24px,4.0vw,54px)] font-semibold text-[#1a1a2e] leading-[1.38] tracking-tight font-heading mx-auto text-center">
            Every CMO is asking their agency the same question:<br className="hidden md:inline" />
            what is your AI story? We have an answer that goes beyond tools and buzzwords.<br className="hidden md:inline" />
            We are building <span className="highlight text-[#2563eb] font-bold">AEO and GEO capabilities</span>,<br className="hidden md:inline" />
            deploying <span className="highlight text-[#2563eb] font-bold">agentic marketing workflows</span><br className="hidden md:inline" />
            and developing <span className="highlight text-[#2563eb] font-bold">AI-native content pipelines</span> for clients.<br className="hidden md:inline" />
            This is not a future roadmap. It is work we are doing now.
          </p>
        </div>
