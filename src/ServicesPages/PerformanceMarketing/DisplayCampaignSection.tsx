      ...
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center order-2 lg:order-1">
            ...
            <div className="display-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img
                  src="/images/BrandingCreative/DarkBlueLogoBg.png"
                  className="display-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-40 pointer-events-none"
                  style={{ filter: 'brightness(0)' }}
                  alt="Display Background Grid"
                />

                {/* Main Illustration */}
                <img
                  src="/images/BrandingCreative/DarkBlueLogo.png"
                  className="display-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.75]"
                  alt="Display Illustration"
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start order-1 lg:order-2">
            ...
            <div className="display-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-blue-50/90">
              <p>
                Banner blindness is real. Generic display ads get scrolled past in seconds. We design and manage display campaigns that cut through, using sharp creative, precise audience layers and placement targeting across the Google Display Network and premium publisher sites.
              </p>
              <p>
                From prospecting campaigns to retargeting sequences, we handle creative production, audience setup and continuous performance optimisation. Every display placement serves a role in the funnel, with reporting that shows exactly what is working and what is not.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full mt-8">
          <h3 className="display-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div key={idx} className="display-deliverable-item service-deliverable-item flex items-start gap-2.5">
...
export default DisplayCampaignSection;
