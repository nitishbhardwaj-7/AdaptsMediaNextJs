...
const AdOpsPublishersSection = () => {
  const containerRef = useRef<HTMLElement>(null);

  const deliverables = [
    "Ad Server Setup & Management",
    "Header Bidding Configuration",
    "Floor Price & Yield Optimisation",
    "Demand Partner Management",
    "Viewability & Revenue Reporting",
  ];
      ...
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center order-2 lg:order-1">
            ...
            <div className="adops-pub-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img
                  src="/images/BrandingCreative/DigitalMarketingLogoBg.png"
                  className="adops-pub-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-40 pointer-events-none"
                  style={{ filter: 'brightness(0)' }}
                  alt="Publisher Ad Ops Background Grid"
                />

                {/* Main Illustration */}
                <img
                  src="/images/BrandingCreative/DigitalMarketingLogo.png"
                  className="adops-pub-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.75]"
                  alt="Publisher Ad Ops Illustration"
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start order-1 lg:order-2">
            ...
            <h2 className="adops-pub-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl font-heading font-normal">
              Maximise Yield. Fill Every Impression. Protect Your Inventory.
            </h2>
            ...
            <div className="adops-pub-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-gray-300">
              <p>
                Publisher ad ops is not just about filling inventory. It is about filling it with the right demand at the right price. Poor yield management leaves money on the table. We run ad operations for publishers that optimise every layer of their stack.
              </p>
              <p>
                Our team manages header bidding setup, ad server configuration, floor pricing strategy and demand partner management to ensure inventory earns what it is worth. We monitor fill rates, CPMs and viewability continuously to keep revenue growing without sacrificing user experience.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full mt-8">
          <h3 className="adops-pub-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div key={idx} className="adops-pub-deliverable-item service-deliverable-item flex items-start gap-2.5">
...
export default AdOpsPublishersSection;
