    ...
    >
      <div className="max-w-[1350px] 2xl:max-w-[1600px] w-full mx-auto px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start">
            ...
            <h2 className="perf-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl font-heading font-normal">
              Pay for Results. Scale What Works. Cut What Does Not.
            </h2>

            <div className="perf-desc service-desc space-y-6 max-w-2xl text-[17px] md:text-[19px] font-light leading-relaxed text-gray-300">
              <p>
                Performance marketing means every dollar is accountable. We build CPA, CPL and revenue-share models across paid channels that align your marketing spend directly with business outcomes. No ambiguous brand metrics, no inflated reach figures that never tie back to revenue.
              </p>
              <p>
                Our team runs campaigns across Google, Meta, TikTok, native ad platforms and affiliate networks simultaneously. We test aggressively, optimise quickly and scale the campaigns that deliver the strongest return, pulling budget from everything that underperforms before it costs you more.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="perf-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img
                  src="/images/BrandingCreative/WhiteLogoBg.png"
                  className="perf-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-40 pointer-events-none"
                  style={{ filter: 'brightness(0)' }}
                  alt="Performance Background Grid"
                />

                {/* Main Illustration */}
                <img
                  src="/images/BrandingCreative/WhiteLogo.png"
                  className="perf-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.75]"
        ...
        <div className="w-full mt-8">
          <h3 className="perf-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div key={idx} className="perf-deliverable-item service-deliverable-item flex items-start gap-2.5">
