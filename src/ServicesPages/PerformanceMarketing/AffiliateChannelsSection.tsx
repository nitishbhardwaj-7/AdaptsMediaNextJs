...
const AffiliateChannelsSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full py-24 md:py-32 flex justify-center overflow-hidden bg-[#064ed3] text-white">
      ...
      <Image
        ...
        alt="Affiliate Channels Background"
        fill
        priority={true}
        quality={90}
      ...
      <div className="max-w-[1350px] w-full px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="affiliate-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                ...
                <img 
                  ...
                  className="affiliate-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-80 pointer-events-none" 
                ...
                <img 
                  ...
                  alt="Affiliate Channels Illustration" 
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start order-1 lg:order-2">
            ...
            <h2 className="affiliate-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl font-heading">
              Affiliate Channels that Scale Influence
            </h2>

            <div className="affiliate-desc service-desc space-y-6 max-w-xl text-[17px] md:text-[19px] font-light leading-relaxed text-blue-50/90">
              <p>
                Create a network of trusted partners that drive high-intent users directly to your product. We design and manage affiliate programs that align performance incentives with quality conversions.
              </p>
              <p>
                From recruitment to tracking and compliance, we handle every detail to ensure clear attribution and sustainable partner relationships.
              </p>
            </div>
          </div>
        </div>
...
export default AffiliateChannelsSection;
