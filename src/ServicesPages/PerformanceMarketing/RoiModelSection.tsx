      ...
      <div className="max-w-[1350px] w-full px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center order-2 lg:order-1">
            ...
            <div className="roi-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img 
                  src="/images/BrandingCreative/DarkBlueLogoBg.png" 
                  className="roi-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-80 pointer-events-none" 
                ...
                <img 
                  ...
                  className="roi-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.75]" 
                  alt="ROI Model Illustration" 
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start order-1 lg:order-2">
            ...
            <h2 className="roi-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl font-heading">
              ROI Modeling for Long-Term Value
            </h2>

            <div className="roi-desc service-desc space-y-6 max-w-xl text-[17px] md:text-[19px] font-light leading-relaxed text-blue-50/90">
              <p>
                Stop guessing your return on ad spend. We build robust financial models that map client acquisition cost against customer lifetime value.
              </p>
              <p>
                This ensures every marketing dollar spent is aligned with your brand's bottom-line profitability and scaling objectives.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full mt-8">
          <h3 className="roi-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div key={idx} className="roi-deliverable-item service-deliverable-item flex items-start gap-2.5">
...
export default RoiModelSection;
