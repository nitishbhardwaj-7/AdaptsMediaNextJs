...
const FrontBackEndSection = () => {
  ...
  const deliverables = [
    ...
    "Database Strategy & Scaling",
    "Deployment Pipelines & CDN",
  ];
      ...
      <div className="max-w-[1350px] w-full px-8 md:px-16 flex flex-col gap-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 service-content-wrapper flex flex-col items-start">
            ...
            <h2 className="frontend-title service-title text-4xl md:text-5xl lg:text-[56px] tracking-tight leading-[1.25] pb-2 mb-8 max-w-2xl text-slate-900 font-heading">
              Clean Code, Scalable Performance
            </h2>

            <div className="frontend-desc service-desc space-y-6 max-w-xl text-[17px] md:text-[19px] font-light leading-relaxed text-slate-600">
              <p>
                We construct digital web apps with scalability, performance, and responsive layout fidelity in mind. Our codebases are designed to be fast, secure, and easily maintained.
              </p>
              <p>
                From interactive custom React/NextJS frontends to secure Node/Python server architectures, we deliver high-velocity web experiences.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            ...
            <div className="frontend-img-container service-img-container relative w-full max-w-[300px] aspect-square flex items-center justify-center">
              <div className="w-full h-full relative">
                {/* Background Grid */}
                <img 
                  src="/images/BrandingCreative/DesignSystemLogoBg.png" 
                  className="frontend-img-bg service-img-bg absolute inset-0 w-full h-full object-contain scale-110 z-0 opacity-80 pointer-events-none" 
                ...
                <img 
                  ...
                  className="frontend-img-main service-img-main relative z-10 w-full h-full object-contain scale-[0.75]" 
        ...
        <div className="w-full mt-8">
          <h3 className="frontend-deliverables-header service-deliverables-header text-xl md:text-2xl mb-6 text-slate-900">
            What We Deliver
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            {deliverables.map((item, idx) => (
              <div key={idx} className="frontend-deliverable-item service-deliverable-item flex items-start gap-2.5">
